...
const Tasklists = ({ tasks, handleinpu, handledelete, handleedit}) => {
    return (
                            ...
                            tasks.map((item, index) => (
                                ...
                                <li key={index} className="flex justify-between items-center p-2 mb-1.5 border rounded-md">
                                    ...
                                    <div className="flex space-x-2 transition-opacity">
                                        <button onClick={handleedit} className="p-1 rounded-full hover:bg-gray-200 hover:cursor-pointer ">
                                            <Edit  className="h-4 w-4 text-gray-500 " />
                                        </button>
                                        <button onClick={handledelete} className="p-1 rounded-full hover:bg-gray-200 cursor-pointer ">
